...
BOOL RA3_ImageLoad( ra3IMG *Im, CHAR *FileName )
{
  ...
  memset(Im, 0, sizeof(ra3IMG));

  /* Load image from file */
  hBm = LoadImage(NULL, "duck.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
  if (hBm == NULL)
    return FALSE;
